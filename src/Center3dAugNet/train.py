...
CPFOLDER = '/disks/hdd/pku/article/baseline'
...
class CarDataset(Dataset):
    ...
    def __init__(self, dataframe, root_dir, training=True, transform=None, flag=None):
        self.df = dataframe
...
train_dataset = CarDataset(df_train, train_images_dir, flag=True)
...
model.load_state_dict(torch.load(os.path.join(CPFOLDER, 'epoch_44.pth'))['model'])
